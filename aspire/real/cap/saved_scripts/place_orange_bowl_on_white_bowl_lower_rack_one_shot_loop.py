...
wrist rotation, but targets the detected white dish/bowl as the shelf support.
Placement uses planner transport to the open shelf mouth, one-axis Y alignment,
one-axis X insertion, a straight-down Z place step, release, vertical clear,
X retreat, home/open grippers.
"""
...
def _configure_orange_on_white_defaults() -> None:
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OBJECT_NAME", "orange bowl")
    _force_env("OPENFORGE_BOWL_RACK_TASK_NAME", "place_orange_bowl_on_white_bowl_lower_rack_one_shot_loop")
    _force_env("OPENFORGE_BOWL_RACK_OBJECT_NAME", "orange bowl")
    _force_env("OPENFORGE_BOWL_RACK_ARTIFACT_PREFIX", "orange_bowl_on_white_bowl_lower_rack")
    _force_env(
        "OPENFORGE_BOWL_RACK_SCRIPT_PATH",
        "cap/saved_scripts/place_orange_bowl_on_white_bowl_lower_rack_one_shot_loop.py",
    )
    ...
    _force_env("OPENFORGE_BOWL_RACK_EXPECTED_TICKET_SCOPE", "orange_bowl_on_white_bowl_lower_rack")
    ...
    _force_env(
        ...
        "orange bowl,white dish,white bowl,white plate,dish,plate,bottom shelf,lower shelf,wooden rack,rack,blue gripper fingers",
    )
    _force_env("OPENFORGE_BOWL_RACK_TARGET_PROMPTS", "white dish,white bowl,white plate,dish,plate")
    ...
    _force_env("OPENFORGE_BOWL_RACK_CLOSE_STEPS", "0.68,0.30,0.08,0.00")
    ...
    _force_env("OPENFORGE_BOWL_RACK_GRIPPER_SETTLE_S", "0.03")
    ...
    _force_env("OPENFORGE_BOWL_RACK_RELEASE_CONFIRM_POS", "0.50")
    ...
    _force_env("OPENFORGE_BOWL_TOP_DOWN_LIFT_Z_M", "0.120")
    _force_env("OPENFORGE_BOWL_TOP_DOWN_LIFT_STEP_M", "0.070")
    ...
    _force_env("OPENFORGE_BOWL_TOP_DOWN_RIM_INWARD_OFFSET_M", "0.025")
    ...
    _force_env("OPENFORGE_BOWL_TOP_DOWN_CLOSE_STEPS", "0.68,0.30,0.08,0.00")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_TARGET_X_BIAS_M", "0.025")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_TARGET_Y_BIAS_M", "0.025")
    _default_env("OPENFORGE_BOWL_LOWER_RACK_FRONT_STANDOFF_M", "0.060")
    _default_env("OPENFORGE_BOWL_LOWER_RACK_FRONT_X_STANDOFF_M", "0.080")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_FRONT_Z_LIFT_M", "0.065")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_ENTRY_Z_LIFT_M", "0.000")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_RELEASE_Z_LIFT_M", "0.025")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_SUPPORT_Z_M", "")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_SUPPORT_Z_OFFSET_M", "0.000")
    _default_env("OPENFORGE_BOWL_LOWER_RACK_RETREAT_STANDOFF_M", "0.080")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_MAX_IK_ERROR_M", "0.045")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_POST_LIFT_J5_REORIENT", "1")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_POST_LIFT_J5_DELTA_DEG", "45.0")
    _force_env(
        "OPENFORGE_BOWL_LOWER_RACK_POST_LIFT_J5_DELTA_CANDIDATES_DEG",
        "45.0,30.0,60.0,15.0,0.0,-30.0,-45.0",
    )
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_PLACE_DOWN_MAX_Z_DELTA_M", "0.140")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_RETREAT_MAX_XY_DELTA_M", "0.030")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_RETREAT_MAX_Z_DELTA_M", "0.140")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_INSERT_SPLIT_Y_THEN_X", "0")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_PLACE_DOWN_Z", "1")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_Y_ALIGN_MAX_XY_DELTA_M", "0.260")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_X_INSERT_MAX_XY_DELTA_M", "0.260")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_X_RETREAT_MAX_XY_DELTA_M", "0.140")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_Y_RETREAT_MAX_XY_DELTA_M", "0.180")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_MAX_Z_DELTA_M", "0.020")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_Y_ALIGN_Z_BOOST_M", "0.020")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_X_INSERT_Z_BOOST_M", "0.020")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_TRANSPORT_MAX_Z_DELTA_M", "0.050")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_TRANSPORT_MAX_Z_TARGET_ERROR_M", "0.065")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_PRE_INSERT_X_UP_TILT", "0")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIRECT_PLACE_DOWN_MAX_Z_DELTA_M", "0.160")
    ...
    _force_env("OPENFORGE_BOWL_LOWER_RACK_POST_RELEASE_CLEAR_MAX_IK_ERROR_M", "0.075")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_POST_RELEASE_CLEAR_MAX_XY_DRIFT_M", "0.055")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_VERTICAL_CLEAR_AFTER_RELEASE", "1")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_SKIP_XY_RETREAT_AFTER_VERTICAL_CLEAR", "0")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_OPEN_FRONT_SLIDE_Y_RETREAT_AFTER_VERTICAL_CLEAR", "0")
    _force_env("OPENFORGE_BOWL_LOWER_RACK_DIAGONAL_RETREAT_AFTER_RELEASE", "0")
...
_configure_orange_on_white_defaults()

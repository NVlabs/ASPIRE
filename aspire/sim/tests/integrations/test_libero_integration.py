...
from aspire.sim.cap.integrations import libero as lib_mod
...
def test_load_libero_task(monkeypatch: object) -> None:
    ...
    def get_benchmark_dict(*args, **kwargs):  # noqa: D401, ARG001
    ...
    # Create fake package/module hierarchy for the import shape used by load_libero_task.
    ...
    libero_pkg.benchmark = benchmark_mod  # type: ignore[attr-defined]
    libero_pkg.envs = envs_mod  # type: ignore[attr-defined]
    libero_pkg.utils = utils_mod  # type: ignore[attr-defined]

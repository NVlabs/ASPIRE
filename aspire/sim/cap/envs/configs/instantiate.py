...
def locate(name: str) -> Any:
    ...
    # Adapted from hydra.utils._locate at
    # https://github.com/facebookresearch/hydra/blob/57690d7c4e8b5e88dad07d67278f613a739e6d13/hydra/_internal/utils.py#L614-L665
    # Copyright (c) Facebook, Inc. and its affiliates. Licensed under MIT;
    # see LICENSES/MIT-Hydra.txt in the repository root.

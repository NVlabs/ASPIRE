...
class LiberoBatchLaunchArgs:
    ...
    base_config_path: str = "env_configs/libero/franka_libero_baseline_debug.yaml"
    ...
    """If non-empty, only run tasks whose name contains one of these substrings."""
...
def main(args: LiberoBatchLaunchArgs) -> None:
    ...
    for suite_name in args.suites:
        ...
        for task_id in range(num_tasks):
            ...
            if args.task_names and not any(f in task_name for f in args.task_names):
                continue

...
Usage in API code (e.g., agibot_api.py):
    from aspire.sim.cap.utils.execution_logger import log_step, log_step_update
...
For VLM analysis:
    from aspire.sim.cap.utils.execution_logger import get_execution_steps_with_images

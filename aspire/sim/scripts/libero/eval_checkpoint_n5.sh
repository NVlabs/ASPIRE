...
#
# Usage:
#   bash scripts/libero/eval_checkpoint_n5.sh [--gpus "2 3 4 5 6 7"] [--workers-per-gpu 2]

set -euo pipefail

WORKTREE="$ASPIRE_ROOT/outputs/worktrees/snapshot-N5/aspire/sim"
...
BASE="$WORKTREE/outputs/scaling_eval/snapshot-N5/debug_eval"
SEEDS=50
GPUS="2 3 4 5 6 7"
WORKERS_PER_GPU=2
...
# Checkpoint map: "suite/task|pct|iter_glob"
# 25% checkpoints
CHECKPOINTS=(
    "libero_10_swap|LIVING_ROOM_SCENE2_put_both_the_alphabet_soup_and_the_tomato_sauce_in_the_basket|25pct|iter_2_"
    "libero_10_swap|LIVING_ROOM_SCENE5_put_the_white_mug_on_the_left_plate_and_put_the_yellow_and_white_mug_on_the_right_plate|25pct|iter_2_"
    "libero_10_swap|LIVING_ROOM_SCENE6_put_the_white_mug_on_the_plate_and_put_the_chocolate_pudding_to_the_right_of_the_plate|25pct|iter_4_"
    "libero_10_task|LIVING_ROOM_SCENE2_put_both_the_cream_cheese_box_and_the_butter_in_the_basket|25pct|iter_3_"
    "libero_10_task|LIVING_ROOM_SCENE6_put_the_white_mug_on_the_plate_and_put_the_chocolate_pudding_to_the_right_of_the_plate|25pct|iter_3_"
    # 50% checkpoints
    "libero_10_swap|LIVING_ROOM_SCENE2_put_both_the_alphabet_soup_and_the_tomato_sauce_in_the_basket|50pct|iter_3_"
    "libero_10_swap|LIVING_ROOM_SCENE5_put_the_white_mug_on_the_left_plate_and_put_the_yellow_and_white_mug_on_the_right_plate|50pct|iter_5_"
    "libero_10_swap|LIVING_ROOM_SCENE6_put_the_white_mug_on_the_plate_and_put_the_chocolate_pudding_to_the_right_of_the_plate|50pct|iter_7_"
    "libero_10_task|LIVING_ROOM_SCENE2_put_both_the_cream_cheese_box_and_the_butter_in_the_basket|50pct|iter_5_"
    "libero_10_task|LIVING_ROOM_SCENE6_put_the_white_mug_on_the_plate_and_put_the_chocolate_pudding_to_the_right_of_the_plate|50pct|iter_5_"
)

echo "=== snapshot-N5 checkpoint eval ==="
...
# Build work list interleaved by seed so workers spread across GPUs immediately.
# Order: seed1/ckpt0, seed1/ckpt1, ..., seed1/ckptN, seed2/ckpt0, ...
WORK_LIST=$(mktemp)
CKPT_CODES=()
CKPT_SUITES=()
CKPT_TASKS=()
...
for entry in "${CHECKPOINTS[@]}"; do
    ...
    CKPT_PCTS+=("$pct")
    CKPT_GPUS+=("$gpu")
    echo "  ckpt $pct $suite/${task:0:30}: $(basename "$code") → GPU $gpu"
    ckpt_idx=$((ckpt_idx + 1))
done
...
_run_one_ckpt() {
    ...
    "$PYTHON" "$REPLAY" \
        ...
        > "/tmp/ckpt_eval_${suite##libero_10_}_${task:14:6}_${pct}_s${seed}.log" 2>&1 || true
}

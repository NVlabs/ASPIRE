---
name: robosuite/fix-loop/clean-task-slate
...
- `.claude/robosuite/fix-loop/skills/localize.md` — prompt registry rows for this task
- `.claude/robosuite/fix-loop/skills/grasp.md` — grasp strategies specific to this task
- `.claude/robosuite/fix-loop/skills/transport.md` — motion patterns specific to this task
...
echo "=== Skill entries ==="
grep -n "$TASK" .claude/robosuite/fix-loop/skills/localize.md .claude/robosuite/fix-loop/skills/grasp.md .claude/robosuite/fix-loop/skills/transport.md 2>/dev/null
```

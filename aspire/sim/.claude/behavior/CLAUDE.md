...
Setup is a single command, `scripts/behavior/setup_behavior.sh --accept-dataset-license`, followed by
`scripts/behavior/verify_behavior.py`. Do not run `cap/third_party/b1k/uv_install.sh` directly — it does
